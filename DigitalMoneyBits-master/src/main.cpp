...
static unsigned int GetNextTargetRequired_Retarget(const CBlockIndex* pindexLast, bool fProofOfStake)
{
...
{
    return GetNextTargetRequired_Retarget(pindexLast, fProofOfStake);
}
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    // block.hashMerkleRoot == e73e5bb110c8afcb53fab055c4895492894b1ba2ecac27bd45ba63d82de68951
    // block.nTime = 1494115200
    // block.nNonce = 650563
    // block.GetHash = 0000026ad202d3d64079576f59544df412a8bc59f5b62d415b1f16104564783c
    //
    // Testnet Genesis hash
    // block.hashMerkleRoot == e73e5bb110c8afcb53fab055c4895492894b1ba2ecac27bd45ba63d82de68951
    // block.nTime = 1494115200
    // block.nNonce = 84918
    // block.GetHash = 0000526a741ca29f42e7ed820d870456745d986daa9ed620689e1bfa0de2d9b2
    if (mapBlockIndex.empty())
    {
        if (!fAllowNew)
            return false;

        const char* pszTimestamp = "Digital Money Bits starts up | Sun, 07 May 2017 00:00:00 GMT";
        CTransaction txNew;
        txNew.nTime = 1494115200; // Sun, 07 May 2017 00:00:00 GMT
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1494115200; // Sun, 07 May 2017 00:00:00 GMT
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe73e5bb110c8afcb53fab055c4895492894b1ba2ecac27bd45ba63d82de68951"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x3f, 0xf3, 0x4f, 0xf4 };
